...
def getSector(mas,mainDotIndex):
    q1 = []
    q2 = []
    q3 = []
    q4 = []
...
for index in range(0,200):
    sectors = getSector(mas,index)
    dotsIdsCoord = list(getDots(mas, index, sectors)) 
    dots = getCoords(dotsIdsCoord, mas, index)
    mainDot = mas[index]
    ##
